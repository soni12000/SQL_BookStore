In this project, I worked with three CSV files (Books, Customers, and Orders) to retrieve, filter, and summarize data using SQL queries. By leveraging SQL, I was able to:
